...
; (function (window) {
   ...
   * @param timeStamp - 毫秒
   */
  h.timeFormatCountDown = function(timeStamp) {
    let d, h, m, s;
    if (timeStamp >= 0) {
      ...
      m = '00';
      s = '00';
      this.countDown.deadline = true;
      clearTimeout(h.countDown.timer);
    }
    this.countTimeDate.d = d;
    this.countTimeDate.h = h;
    this.countTimeDate.m = m;
    this.countTimeDate.s = s;
    if (!this.countDown.deadline) {
      h.countDown.timer = setTimeout(() => {
        this.countDown(timeStamp - 1000);
      }, 1000);
    }
  }
